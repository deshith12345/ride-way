...
function DriverLoginContent() {
    ...
    return (
        <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-950 p-6">
            ...
            <div className="absolute top-1/4 -left-32 h-80 w-80 animate-pulse rounded-full bg-emerald-600/15 blur-[120px]" />
            <div className="absolute bottom-1/4 -right-32 h-80 w-80 animate-pulse rounded-full bg-teal-600/10 blur-[120px] delay-1000" />
            ...
            <div className="relative z-10 w-full max-w-md animate-in fade-in zoom-in duration-700">
                ...
                <div className="mb-8 flex flex-col items-center text-center">
                    ...
                    <div className="mb-2 flex items-center gap-2">
                        ...
                        <span className="text-xs font-black uppercase tracking-[0.2em] text-emerald-400">Driver Portal</span>
                    </div>
                    <h1 className="text-3xl font-black tracking-tight text-white drop-shadow-md">Driver Sign In</h1>
                    <p className="mt-2 font-medium text-slate-400">Access your trips, schedules and ticket scanner</p>
                </div>
                ...
                <div className="rounded-3xl border border-white/10 bg-white/5 p-8 pt-10 shadow-[0_20px_60px_rgba(0,0,0,0.5)] backdrop-blur-2xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-2">
                            <Label htmlFor="driver-email" className="ml-1 text-[11px] font-bold uppercase tracking-wider text-slate-400">
                                Email Address
                            </Label>
                            <Input
                                id="driver-email"
                                ...
                                className="h-12 rounded-xl border-white/10 bg-white/5 font-medium text-white placeholder:text-slate-600 transition-all focus:border-emerald-500/50 focus:ring-emerald-500/30"
                                required
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between px-1">
                                <Label htmlFor="driver-password" className="text-[11px] font-bold uppercase tracking-wider text-slate-400">
                                    Password
                                </Label>
                                <Link href="/forgot-password" className="text-[11px] font-black uppercase tracking-wider text-emerald-400 hover:text-emerald-300">
                                    Forgot?
                                </Link>
                            </div>
                            <Input
                        ...
                        <Button
                            ...
                            className="h-14 w-full rounded-2xl bg-emerald-600 text-lg font-black text-white shadow-lg shadow-emerald-900/50 transition-all hover:bg-emerald-500 active:scale-95"
                            disabled={loading}
                        >
                            {loading ? (
...
export default function DriverLoginPage() {
    return (
        <Suspense fallback={<div className="flex min-h-screen items-center justify-center bg-slate-950"><Loader2 className="h-10 w-10 animate-spin text-emerald-500" /></div>}>
            <DriverLoginContent />
        </Suspense>
    )
}
